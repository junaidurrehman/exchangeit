...
<div id="myCarousel" class="carousel slide height1" data-ride="carousel">
	...
	<div class="carousel-inner imgheight" role="listbox">
		<div class="item active upper">
			<img class="first-slide picheight" src="<?php echo  base_url() ?>codeigniter/assets/images/web/hand.jpg"
				alt="First slide">
			<div class="container">
				<div class="carousel-caption settin">
					...
					<p>Here you can exchange your items with desired ones and if you
						...
						enjoy!</p>
					<p>
						<a class="btn btn-lg btn-primary" href="index.php?page=signup" role="button">Sign up
							Now</a>
					</p>
				</div>
			</div>
		...
		<div class="item">
			<img class="second-slide " src="<?php echo  base_url() ?>codeigniter/assets/images/web/barter1.png"
				alt="Second slide">
			<div class="container">
				<div class="carousel-caption settin">
		...
		<div class="item">
			<img class="third-slide" src="<?php echo  base_url() ?>codeigniter/assets/images/web/barter.jpg"
				alt="Third slide">
			<div class="container">
				<div class="carousel-caption settin">
					<p>
