...
class Users extends MX_Controller {
	...
	function change_password()
	{
		...
		if ($this->form_validation->run() == false)
		{
			...
			// render
			$this->_render_page('users/change_password', $data);
		}
		else
		{
	...
	public function reset_password($code = NULL)
	{
		...
		if ($user)
		{
			...
			if ($this->form_validation->run() == false)
			{
				...
				// render
				$this->_render_page('users/reset_password', $data);
			}
			else
			{
	...
	function deactivate($id = NULL)
	{
		...
		if ($this->form_validation->run() == FALSE)
		{
			...
			$this->_render_page('users/deactivate_user', $data);
		}
		else
		{
...
// 			);
	...
	function create_group()
	{
		...
		else
		{
			...
			$this->_render_page('users/create_group', $data);
		}
	}
	...
	function edit_group($id)
	{
		...
		$this->_render_page('users/edit_group', $data);
	}
